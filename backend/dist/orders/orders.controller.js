...
let OrdersController = class OrdersController {
    ...
    findAll(req, page = 1, limit = 10) {
        return this.ordersService.findAll(req.user.id, req.user.role === 'admin', page, limit);
    }
    findById(id, req) {
        return this.ordersService.findById(id, req.user.id, req.user.role === 'admin');
    }
    create(req, data) {
        return this.ordersService.create(req.user.id, data.items, data.shippingAddress, data.paymentMethod);
    }
