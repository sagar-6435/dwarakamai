...
const stats = [
  ...
  { label: "Total Revenue", value: "₹0", icon: <BarChart3 size={24} />, color: "bg-brand-gold" },
];
  ...
  return (
    <div className="p-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {quickActions.map((action, i) => (
            <div key={i} className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group">
              <div className={`${action.color} w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform`}>
                {action.icon}
              </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center text-gray-400 border-2 border-dashed border-gray-100 rounded-2xl">
