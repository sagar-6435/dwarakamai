          ...
          <div key={item.id} className="bg-white rounded-3xl border border-gray-100 overflow-hidden group shadow-sm hover:shadow-xl transition-all">
            <div className="aspect-[4/3] relative">
              ...
              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                <button className="p-3 bg-white/20 backdrop-blur-md rounded-full text-black hover:bg-white/40 transition-all"><Maximize2 size={18} /></button>
                <button className="p-3 bg-rose-500/80 backdrop-blur-md rounded-full text-black hover:bg-rose-600 transition-all"><Trash2 size={18} /></button>
              </div>
            ...
            <div className="p-5">
              ...
              <p className="text-xs text-gray-600 mt-1">Uploaded on Oct 24, 2023</p>
            </div>
          </div>
        ))}
      </div>
