      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="text" defaultValue="Capture Memories. Create Emotions." className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-brand-gold" />
            </div>
            <div>
              <label className="text-xs font-bold text-gray-400 uppercase tracking-widest block mb-2">Subheadline</label>
              <textarea rows={3} defaultValue="Celebrate Every Moment with our premium digital studio services." className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-brand-gold resize-none" />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                ...
                <div className={`w-12 h-6 rounded-full transition-all relative cursor-pointer ${mod.enabled ? "bg-brand-gold" : "bg-gray-300"}`}>
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-6 lg:col-span-2">
          <div className="flex items-center justify-between pb-4 border-b border-gray-50">
            ...
            <button className="text-xs font-bold text-brand-gold hover:underline uppercase tracking-widest">+ Add New</button>
          </div>
