      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 md:py-0 md:px-12 lg:px-20">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5">
            ...
            <button
              type="button"
              className="w-full py-3.5 bg-brand-orange text-brand-white font-bold uppercase tracking-widest text-sm rounded-sm hover:bg-brand-orange-light transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(212,175,55,0.3)]"
            >
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            {isSignup ? (
              <>Already have an account?{" "}
                <button onClick={() => setIsSignup(false)} className="text-brand-orange hover:underline">Login</button>
              </>
            ) : (
              <>Don&apos;t have an account?{" "}
                <button onClick={() => setIsSignup(true)} className="text-brand-orange hover:underline">Sign Up</button>
              </>
            )}
          </div>
