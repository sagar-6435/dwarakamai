...
export default function WhyChooseUs() {
  return (
    <section id="about" className="py-14 md:py-24 bg-brand-white relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-brand-orange/5 blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-1/2 h-full bg-brand-orange/5 blur-[150px] pointer-events-none" />
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-4 md:p-8 glass rounded-xl border border-brand-gray hover:border-brand-orange/30 transition-colors duration-300"
              >
                <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none">
                  <Icon size={100} className="text-brand-orange" />
                </div>
                
                <div className="w-14 h-14 bg-brand-gray rounded-full flex items-center justify-center mb-6 group-hover:bg-brand-orange/20 transition-colors duration-300">
                  <Icon size={24} className="text-brand-orange" />
                </div>
                
                <h3 className="font-heading text-xl font-bold text-black mb-3 group-hover:text-brand-orange transition-colors duration-300">
                  {feature.title}
                </h3>
