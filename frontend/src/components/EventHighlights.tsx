    ...
    <section className="py-14 md:py-24 bg-brand-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Event <span className="text-brand-orange">Highlights</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            return (
              ...
              >
                ...
                <div className="w-full md:w-1/2 rounded-2xl overflow-hidden aspect-[4/3] group relative">
                  ...
                  <span className="absolute top-4 left-4 px-3 py-1 bg-brand-white/70 border border-brand-orange/30 text-brand-orange text-xs font-bold uppercase tracking-widest rounded-full">
                    {item.label}
                  </span>
                </div>
                ...
                <div className="w-full md:w-1/2 space-y-6">
                  ...
                  <h3 className="font-heading text-2xl md:text-3xl font-bold text-black">{item.title}</h3>
                  <p className="text-gray-600 leading-relaxed">{item.description}</p>
                  <Link href={item.href}>
                    <button className="inline-flex items-center gap-2 px-6 py-3 bg-brand-orange text-brand-white text-sm font-bold uppercase tracking-wider rounded-sm hover:bg-brand-orange-light transition-all shadow-[0_0_15px_rgba(212,175,55,0.2)]">
